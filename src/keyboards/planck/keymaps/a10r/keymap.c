 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Win  | Alt  | XXX  |Symbol|    Space    | Func | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------' */
...
[DE_NUM] = LAYOUT_planck_grid(
	_______, _______, _______, _______, _______, _______, DE_MINS, DE_7,    DE_8,    DE_9,    DE_ASTR, _______,
	_______, _______, _______, _______, _______, _______, DE_EQL,  DE_4,    DE_5,    DE_6,    DE_0,    _______,
	_______, _______, _______, _______, _______, _______, DE_PLUS, DE_1,    DE_2,    DE_3,    DE_SLSH, _______,
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
